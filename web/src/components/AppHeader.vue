...
<template>
    <header
        ...
        <div class="mx-auto flex max-w-[1400px] items-center gap-3 px-4 py-3 lg:gap-4">
            <RouterLink to="/" class="flex min-w-0 shrink-0 items-center gap-2 font-bold text-brand-primary">
                ...
                <span class="hidden truncate sm:inline">{{ settingsStore.settings?.store_name ?? 'Cargando...' }}</span>
            </RouterLink>
            ...
            <nav
                class="hidden shrink-0 gap-5 text-sm font-medium text-gray-600 dark:text-gray-300 lg:ml-2 lg:flex xl:gap-6">
                <RouterLink to="/" class="whitespace-nowrap hover:text-brand-primary">Inicio</RouterLink>
                <RouterLink to="/catalogo" class="whitespace-nowrap hover:text-brand-primary">Catálogo</RouterLink>
                <RouterLink to="/nosotros" class="whitespace-nowrap hover:text-brand-primary">Nosotros</RouterLink>
                <RouterLink to="/reservar-mantenimiento" class="whitespace-nowrap hover:text-brand-primary">
